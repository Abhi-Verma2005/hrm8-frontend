...
import { SourceEffectivenessMetrics as OldSourceMetrics } from "@/lib/analyticsService";

interface RecruitmentSourceChartProps {
  data: OldSourceMetrics[];
}

export function RecruitmentSourceChart({ data }: RecruitmentSourceChartProps) {
  return (
    <Card>
      <CardHeader>
          ...
          <BarChart data={data}>
            ...
            <Tooltip 
              content={({ active, payload }) => {
                ...
                const data = payload[0].payload as OldSourceMetrics;
                return (
