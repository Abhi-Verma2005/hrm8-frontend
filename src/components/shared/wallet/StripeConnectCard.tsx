...
export function StripeConnectCard({ onStatusChange }: StripeConnectCardProps) {
    ...
    const checkStatus = async () => {
        try {
            setLoading(true);
            const response = await apiClient.get<{ payoutEnabled: boolean; detailsSubmitted: boolean }>(
                '/api/consultant-wallet/stripe/status'
            );
    ...
    const handleConnect = async () => {
        try {
            ...
            const response = await apiClient.post<{ accountId: string; onboardingUrl: string }>(
                '/api/consultant-wallet/stripe/onboard'
            );
    ...
    const handleLogin = async () => {
        try {
            ...
            const response = await apiClient.post<{ url: string }>(
                '/api/consultant-wallet/stripe/login'
            );
