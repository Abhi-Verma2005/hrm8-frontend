...
import { UsersRound, Banknote, Plug, FileBarChart } from "lucide-react";
...
export function ManagementSection({ isExpanded, isActive, sectionOpen, onToggleSection }: ManagementSectionProps) {
  return (
    <>
