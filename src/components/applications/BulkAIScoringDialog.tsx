...
import { bulkScoreCandidates, getScoreChangeLabel, getScoreChangeColor, type ScoringCriteria, type BulkScoringProgress, type BulkScoringResult } from '@/lib/bulkAIScoring';
import { updateApplication } from '@/lib/mockApplicationStorage';
