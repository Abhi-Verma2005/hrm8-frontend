/**
 * Audit Logs Page
 * HRM8 Global Admin audit log viewer
 */

import { useState, useEffect } from 'react';
import { useHrm8Auth } from '@/contexts/Hrm8AuthContext';
import { auditLogService, AuditLogEntry, AuditLogStats } from '@/lib/hrm8/auditLogService';
...
export default function AuditLogsPage() {
  ...
  if (!isGlobalAdmin) {
    return (
      <Hrm8PageLayout title="Access Denied" subtitle="You don't have permission to view this page">
        <div className="p-6">
          <Card>
