/**
 * HRM8 Refund Requests Page
 * Admin interface for managing transaction refund requests
 */

import React, { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { CheckCircle, XCircle, DollarSign, Filter } from 'lucide-react';
import { format } from 'date-fns';
import { hrm8RefundRequestService, RefundRequest } from '@/lib/hrm8/refundRequestService';
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                ...
                <p className="text-gray-600">Manage transaction refund requests from employers</p>
            </div>
            ...
            <Card>
                {loading ? (
                    ...
                    <DataTable data={refundRequests} columns={columns} searchable />
                )}
            </Card>
