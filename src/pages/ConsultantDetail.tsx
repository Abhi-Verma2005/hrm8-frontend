...
import { ChangeRoleDialog } from '@/components/consultants/ChangeRoleDialog';
...
export default function ConsultantDetail() {
  ...
  const handleRoleChanged = () => {
    // Refresh consultant data after role change
    if (id) {
      const updated = getConsultantById(id);
      if (updated) {
        setConsultant(updated);
      }
    }
    ...
    <DashboardPageLayout>
      <div className="p-6 space-y-6">
        ...
        <ChangeRoleDialog
          ...
          consultantId={consultant.id}
          consultantName={`${consultant.firstName} ${consultant.lastName}`}
          currentRole={consultant.role as "RECRUITER" | "SALES_AGENT" | "CONSULTANT_360"}
          currentJobs={consultant.currentJobs}
          currentLeads={consultant.currentLeads}
