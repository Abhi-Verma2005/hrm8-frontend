...
import type { AlertRule, NotificationEventType, NotificationChannel } from '@/types/notificationPreferences';
import { userNotificationPreferencesService, type CreateAlertRuleData } from '@/lib/api/userNotificationPreferencesService';
