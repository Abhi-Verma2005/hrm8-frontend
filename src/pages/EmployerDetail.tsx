...
import { CompanyContactsTab } from "@/components/employers/detail/contacts/CompanyContactsTab";
import { CompanyOpportunitiesTab } from "@/components/employers/detail/opportunities/CompanyOpportunitiesTab";
import { CompanyAttributionTab } from "@/components/employers/detail/attribution/CompanyAttributionTab";
import { CompanyAccountTeamTab } from "@/components/employers/detail/accountteam/CompanyAccountTeamTab";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function EmployerDetail() {
  ...
  const handleEdit = () => {
    navigate(`/employers?action=edit&id=${employer.id}`);
  };
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <TabsList className="flex-shrink-0">
              ...
              <TabsTrigger value="accountteam">Account Team</TabsTrigger>
          ...
          <TabsContent value="contacts">
            <CompanyContactsTab companyId={employer.id} />
          </TabsContent>

          {/* Opportunities Tab */}
          <TabsContent value="opportunities">
            <CompanyOpportunitiesTab companyId={employer.id} />
          </TabsContent>

          {/* Attribution Tab */}
          <TabsContent value="attribution">
            <CompanyAttributionTab companyId={employer.id} />
          </TabsContent>

          {/* Account Team Tab */}
          <TabsContent value="accountteam">
            <CompanyAccountTeamTab companyId={employer.id} />
          </TabsContent>
